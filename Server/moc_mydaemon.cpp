...
struct qt_meta_stringdata_MyDaemon_t {
    QByteArrayData data[4];
    char stringdata0[37];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyDaemon_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyDaemon_t qt_meta_stringdata_MyDaemon = {
    {
QT_MOC_LITERAL(0, 0, 8), // "MyDaemon"
QT_MOC_LITERAL(1, 9, 12), // "handleSigHup"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13) // "handleSigTerm"

    },
    "MyDaemon\0handleSigHup\0\0handleSigTerm"
};
...
const QMetaObject MyDaemon::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyDaemon.data,
      qt_meta_data_MyDaemon,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyDaemon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyDaemon.stringdata0))
